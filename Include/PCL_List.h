...
static const uint VIteratorClassCode = VIRTUALCODE(false);
...
static const uint VListClassCode = VIRTUALCODE(true);

class VList : public VContainer, public VIterator {
public:
///!
///! CallBacks: 
...
///!
static const uint GIteratorClassCode = CLASSCODE(VIteratorClassCode);

class PCL_API GIterator : public VIterator {
public: static const uint ClassCode() {return GIteratorClassCode;};
protected: GIterator();
	virtual ~GIterator();
protected:
...
static const uint GListClassCode = CLASSCODE(VListClassCode);

class PCL_API GList : public VList {
public: static const uint ClassCode() {return GListClassCode;};
protected: GList();
	virtual ~GList(); GList(const pcont pContainer);
...
///!
static const uint LListIteratorClassCode = CLASSCODE(GIteratorClassCode);

class PCL_API LListIterator : public GIterator {
public: static const uint ClassCode() {return LListIteratorClassCode;};
public:
	friend class LList;
protected:
...
static const uint LVectorIteratorClassCode = CLASSCODE(GIteratorClassCode);

class PCL_API LVectorIterator : public GIterator {
public: static const uint ClassCode() {return LVectorIteratorClassCode;};
public:
...
static const uint LCollectionIteratorClassCode = CLASSCODE(GIteratorClassCode);

class PCL_API LCollectionIterator : public GIterator {
public: static const uint ClassCode() {return LCollectionIteratorClassCode;};
public:
...
static const uint LListClassCode = CLASSCODE(GListClassCode);

class PCL_API LList : public GList {
public: static const uint ClassCode() {return LListClassCode;};
public: LList(const pcont pContainer);
	virtual void Import(const pcont pContainer, bool AutoRelease = true);
	virtual const pcont Export(void);
public:
	LList(uint ItemSize);
...
static const uint LVectorClassCode = CLASSCODE(GListClassCode);

class PCL_API LVector : public GList {
public: static const uint ClassCode() {return LVectorClassCode;};
public: LVector(const pcont pContainer);
	virtual void Import(const pcont pContainer, bool AutoRelease = true);
	virtual const pcont Export(void);
public:
...
static const uint LCollectionClassCode = CLASSCODE(GListClassCode);

class PCL_API LCollection : public GList {
public: static const uint ClassCode() {return LCollectionClassCode;};
public: LCollection(const pcont pContainer);
	virtual void Import(const pcont pContainer, bool AutoRelease = true);
	virtual const pcont Export(void);
public:
