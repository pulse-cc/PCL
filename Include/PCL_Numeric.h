...
///! Virtual Set
///!
static const uint VSetClassCode = VIRTUALCODE(false);
...
///!
static const uint LSetClassCode = CLASSCODE(VSetClassCode);

class PCL_API LSet : public VSet {
public: static const uint ClassCode() {return LSetClassCode;};
public:
