...
static const uint VNavigatorClassCode = VIRTUALCODE(false);
...
static const uint VTreeClassCode = VIRTUALCODE(true);

class VTree : public VContainer, public VNavigator {
public:
///!
...
///!
static const uint VBrowserClassCode = VIRTUALCODE(false);
...
static const uint VNameSpaceClassCode = VIRTUALCODE(true);

class VNameSpace : public VContainer, public VBrowser {
public:
///!
///! Methods to be Overrided in Descendant Classes (doing nothing by default)
///!
