...
///!
static const uint VContainerClassCode = VIRTUALCODE(false);
...
///!
static const uint VMemAdmClassCode = VIRTUALCODE(false);
...
///!
static const uint VMemoryClassCode = VIRTUALCODE(false);
...
///!
static const uint VItemClassCode = VIRTUALCODE(false);
...
///!
static const uint VCSectClassCode = VIRTUALCODE(false);
...
///!
static const uint VRootClassCode = VIRTUALCODE(false);
...
///! Virtual Event
///!
static const uint VEventClassCode = VIRTUALCODE(false);
...
///! Virtual Mutex
///!
static const uint VMutexClassCode = VIRTUALCODE(false);
...
///!
static const uint GMemAdmClassCode = CLASSCODE(VMemAdmClassCode);

class PCL_API GMemAdm : public VMemAdm {
public: static const uint ClassCode() {return GMemAdmClassCode;};
protected: GMemAdm();
	virtual ~GMemAdm();
protected:
...
///!
static const uint LMemAdmClassCode = CLASSCODE(GMemAdmClassCode);

class PCL_API LMemAdm : public GMemAdm {
public: static const uint ClassCode() {return LMemAdmClassCode;};
public:
protected:
	virtual pvoid _Alloc(uint Size);
	virtual pvoid _Realloc(pvoid ptr, uint Size);
...
///!
static const uint LMemAdmCOMClassCode = CLASSCODE(GMemAdmClassCode);

class PCL_API LMemAdmCOM : public GMemAdm {
public: static const uint ClassCode() {return LMemAdmCOMClassCode;};
public:
protected:
	virtual pvoid _Alloc(uint Size);
	virtual pvoid _Realloc(pvoid ptr, uint Size);
...
///!
static const uint LMemAdmUnicodeClassCode = CLASSCODE(GMemAdmClassCode);

class PCL_API LMemAdmUnicode : public GMemAdm {
public: static const uint ClassCode() {return LMemAdmUnicodeClassCode;};
public:
protected:
	virtual pvoid _Alloc(uint Size);
	virtual pvoid _Realloc(pvoid ptr, uint Size);
...
///!
static const uint LMemoryClassCode = CLASSCODE(VMemoryClassCode);

class PCL_API LMemory : public VMemory {
public: static const uint ClassCode() {return LMemoryClassCode;};
public:
...
///!
static const uint LCSectClassCode = CLASSCODE(VCSectClassCode);

class PCL_API LCSect : public VCSect {
public: static const uint ClassCode() {return LCSectClassCode;};
public:
	LCSect();
///!
///! Public Methods
...
///! Definition of Root
///!
static const uint LRootClassCode = CLASSCODE(VRootClassCode);

class PCL_API LRoot : public VRoot {
public: static const uint ClassCode() {return LRootClassCode;};
public:
	LRoot(uint Reserved);
	~LRoot();
...
///!
static const uint LEventClassCode = CLASSCODE(VEventClassCode);

class PCL_API LEvent : public VEvent {
public: static const uint ClassCode() {return LEventClassCode;};
public:
...
///!
static const uint LMutexClassCode = CLASSCODE(VMutexClassCode);

class PCL_API LMutex : public VMutex {
public: static const uint ClassCode() {return LMutexClassCode;};
public:
